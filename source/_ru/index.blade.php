...
<section id="one" class="wrapper spotlight style1">
  <div class="inner">
    <a href="/ru/about.html" class="image"><img src="../assets/images/pic01.jpg" alt=""></a>
    <div class="content">
      ...
      <a href="/ru/about.html" class="special">Далее</a>
    </div>
  </div>
</section>
@endsection
...
<section id="two" class="wrapper alt spotlight style2">
  <div class="inner">
    <a href="ru/products.html" class="image"><img src="../assets/images/pic02.jpg" alt="" /></a>
    <div class="content">
      ...
      <a href="/ru/products.html" class="special">Далее</a>
    </div>
  </div>
</section>
@endsection
  ...
  <section id="projects" class="wrapper style4">
    <div class="inner">
      ...
      <section class="features">
        <article>
          <a href="/ru/projects/project_1.html" class="image"><img src="../assets/images/pic03.jpg" alt="" /></a>
          <h3 class="major">РСП-10МР</h3>
          <p>Программа повышения эффективности радиолокационной системы посадки самолета</p>
          <a href="/ru/projects/project_1.html" class="special">Далее</a>
        </article>
        <article>
          <a href="/ru/projects/project_2.html" class="image"><img src="../assets/images/pic04.jpg" alt="" /></a>
          <h3 class="major">Nisl placerat</h3>
          <p>Радилокационная станция синтезирования аппертуры Х-диапазона для БПЛА</p>
          <a href="/ru/projects/project_2.html" class="special">Далее</a>
        </article>
